"""
One-off: create the avatar_refs Supabase Storage bucket (public read).
Spec: wiki/spec/image_gen_v2.md (Phase 2 — avatars).
Idempotent — safe to re-run.

Run from project root with venv active:
    python scripts/create_avatar_refs_bucket.py
"""
import os
